...
class InterestJobRunTest {
    ...
    void runsTheInterestJobAndWritesOneRecordPerNonZeroRate() throws Exception {
        ...
        try (AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext()) {
            ...
            context.getEnvironment().setActiveProfiles(InterestJobConfiguration.PROFILE);
            context.register(InterestJobConfiguration.class);
            context.refresh();
        ...
        assertTrue(Files.exists(InterestJobConfiguration.OUTPUT), "no candidate output written");

        List<String> lines = Files.readAllLines(InterestJobConfiguration.OUTPUT);
